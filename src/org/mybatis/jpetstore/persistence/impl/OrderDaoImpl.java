...
public class OrderDaoImpl implements OrderDao {
    ...
    private static final String insertOrderStatusString=
            " INSERT INTO ORDERSTATUS (ORDERID, LINENUM, STATUS)" +
                    "VALUES (?, ?,?)";
    @Override
...
//            preparedStatement.setDate(3, new java.sql.Date(new java.util.Date().getTime()));
    ...
    private static Order resultSetToOrder(ResultSet resultSet) throws Exception{
    ...
    public static void main(String[] args) throws ParseException {
        java.util.Date date = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse("1970-01-02 00:00:00");
